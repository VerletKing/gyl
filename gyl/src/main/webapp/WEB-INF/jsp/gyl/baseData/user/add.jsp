...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${proPath}/images/title_arrow.gif"/> 用户信息
        </div>
...
<div id=MainArea>
    <s:form action="userAction_add.action">
        <div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="${proPath}/css/blue/images/item_point.gif" /> 用户信息 </div> 
        </div>
		...
		<div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="${proPath}/css/blue/images/item_point.gif" /> 岗位设置 </div> 
        </div>
        
		
        <!-- 表单操作 -->
        <div id="InputDetailBar">
            <input type="image" src="${proPath}/images/save.png"/>
            <a href="javascript:history.go(-1);"><img src="${proPath}/images/goBack.png"/></a>
        </div>
    </s:form>
</div>
</body>
