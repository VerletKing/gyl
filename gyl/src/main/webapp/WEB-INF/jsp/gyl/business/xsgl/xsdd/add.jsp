...
<script type="text/javascript">
	$(document).ready(function(){
			...
			GylUtils.business.add.divOpt.wsdjBlurEvent();
			//addEvent_Page();
    	...
    	<td id="rig_top" >
            ...
            <table class="content" style="font-size:12px;">
				...
				<tr>
                    ...
                    <td >
                    	<input type="radio" name="query_zhub.thbz" value="1">退货</input>
                    	<input type="radio" name="query_zhub.thbz" value="2">不退货</input>
                    </td>
				</tr>
            </table>
           </div>
                ...
                <tr align="center">
                    ...
                    <td class="inp" item="spmc">
                    	<div class="inp_search">
                    		<input type="text" class="bdnone" readonly="readonly" name="xsddzhibs[0].spmc"/>
                    ...
                    <td style="border-collapse:collapse;  empty-cells:show;" item="spbm"><input type="text" style="width:100%;" readonly="readonly" name="xsddzhibs[0].spbm"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;" item="xh"><input type="text" style="width:100%;"  readonly="readonly"name="xsddzhibs[0].xh"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;" item="jldw"><input type="text" style="width:100%;" readonly="readonly" name="xsddzhibs[0].jldw"/></td>
