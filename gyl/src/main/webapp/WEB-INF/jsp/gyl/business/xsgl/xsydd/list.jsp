...
<link rel="stylesheet" href="js/jquery.datepick.css" type="text/css">
	...
	<script type="text/javascript">
		$(document).ready(
			function() {
				$("body").data("hidden","query_zhib.xsyddzhubid");
				//点击主表中的某一行加载子表
				GylUtils.business.init.init();
...
<body>
	<table id="wrap">
		<s:form action="xsyddAction_showPageResultUI.action" method="post">
			<tr>
				<td id="rig_top">
				...
				<td id="rig_top">
					<div style="overflow:auto; height:230px; width:1150px;">
						<table cellspacing="0" cellpadding="0" id="maintain-top" align="center" width="2000" style="font-size:12px;">
							...
							<s:iterator value="#pageResult_zhub.item" status="st">
								<!-- field属性是用来确认是主表的tr -->
								<tr field="item_zhub" id="${requestScope.xsyddzhubid}" style="cursor:pointer">
						...
						<p style="width:1800px; height:20px;font-size:12px;">
							<span class="page" style="float:right"> 
								<input type="button" param="1" flag="zhub_firstPage" page="zhub" value="首页" />&nbsp;
								<input type="button" flag="zhub_prePage" param="${pageResult_zhub.currenPage-1}" page="zhub" value="上一页" />&nbsp; 
								<input type="button" param="${pageResult_zhub.currenPage+1}" flag="zhub_nextPage" page="zhub" value="下一页" />&nbsp; 
								<input type="button" param="${pageResult_zhub.totalPage}" flag="zhub_lastPage" page="zhub" value="尾页" />&nbsp; 
								<span>
									转到第
									<input name="query_zhub.currenPage" id="pageNo" type="text" value="${pageResult_zhub.currenPage}" size="4" style="height:16px; width:28px; border:1px solid #999999; background:#FFF; border-radius:0;" />页
							    </span>&nbsp;&nbsp;
							    <input type="button" value="转" style=" padding:0 10px;" />
							</span>&nbsp;&nbsp;
							共有${pageResult_zhub.totalData}条记录，当前第${pageResult_zhub.currenPage}/${pageResult_zhub.totalPage}页
						</p>
					</div>
				</td>
			</tr>
				...
				<td id="right_center">
					<div style="height:213px; width:1150px; overflow:auto;">
						<table cellspacing="0" cellpadding="0" id="maintain-right" style="font-size:12px;" width="2000">
							...
							<s:iterator value="#pageResult_zhib.item" status="st1">
								<!-- 
				                	当点击主表中的某一行的时候，加载子表中的内容，当对子表加载上一页或者下一页的时候，应该针对主表中的某一行加载
				                	所以在子表分页的时候，应该传递一个参数：主表的id
                				-->
								<tr class="other">
									<td align="center" style="background:#E2E2E2;height:19px; border:0; border-right:1px solid #9EB6CE; border-bottom:1px solid #9EB6CE;">
										<s:property value="#st1.index" />
									</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="hh" />
									</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="spbm" />
									</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="spmc" />
									</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="xh" />
									</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="jldw" />
								  	</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="sl" />
									</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="shulv" />
									</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="dpkl" />
									</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="wsdj" />
									</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="hsdj" />
									</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="wsje" />
									</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="hsje" />
									</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="se" />
									</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="zke" />
									</td>
									<td style="border-collapse:collapse;  empty-cells:show;">
										<s:property value="shdw" />
									</td>
								</tr>
							</s:iterator>
						...
						<p style="width:1800px; height:20px;font-size:12px;">
							<span class="page" style="float:right"> 
								<input type="button" param="1" flag="zhib_firstPage" page="zhib" value="首页" />&nbsp;
								<input type="button" flag="zhib_prePage" page="zhib" param="${pageResult_zhib.currenPage-1}" value="上一页" />&nbsp; 
								<input type="button" flag="zhib_nextPage" page="zhib" param="${pageResult_zhib.currenPage+1}" value="下一页" />&nbsp; 
								<input type="button" flag="zhib_lastPage" page="zhib" param="${pageResult_zhib.totalPage}" value="尾页" />&nbsp; 
								<span>
									转到第
									<input name="query_zhib.currenPage" id="pageNo_zhib" type="text" value="${pageResult_zhib.currenPage}" size="4" style="height:16px; width:28px; border:1px solid #999999; background:#FFF; border-radius:0;" />页
								</span>&nbsp;&nbsp;<input type="button" value="转" style=" padding:0 10px;" />
							</span>&nbsp;&nbsp;
							共有${pageResult_zhib.totalData}条记录，当前第 ${pageResult_zhib.currenPage}/${pageResult_zhib.totalPage}页
						</p>
					</div>
				</td>
			</tr>
